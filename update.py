...
BOT_TOKEN = environ.get('BOT_TOKEN', '7099000204:AAFpTWt9UWDfPiEXzYKueRUyZfNb7O141LE')
if len(BOT_TOKEN) == 0:
...
UPSTREAM_REPO = environ.get('UPSTREAM_REPO', 'https://github.com/Sanchit0102/Collab')
